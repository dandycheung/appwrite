...
App::init(function ($utopia, $request, $response, $project, $user, $events, $audits, $usage, $deletes, $database, $dbForInternal, $mode) {
    ...
    switch (App::getEnv('_APP_STORAGE_DEVICE', Storage::DEVICE_LOCAL)) {
        ...
        case Storage::DEVICE_DO_SPACES:
            $s3AccessKey = App::getEnv('_APP_STORAGE_DEVICE_DO_SPACES_ACCESS_KEY', '');
            $s3SecretKey = App::getEnv('_APP_STORAGE_DEVICE_DO_SPACES_SECRET', '');
            $s3Region = App::getEnv('_APP_STORAGE_DEVICE_DO_SPACES_REGION', '');
            $s3Bucket = App::getEnv('_APP_STORAGE_DEVICE_DO_SPACES_BUCKET', '');
            $s3Acl = 'private';
            ...
            Storage::setDevice('functions', new DoSpaces(APP_STORAGE_FUNCTIONS . '/app-' . $project->getId(), $s3AccessKey, $s3SecretKey, $s3Bucket, $s3Region, $s3Acl));
            break;
    }
